    ...
    <div class="container">
        ...
        <div class="stories">
            <div class="story col-3" data-bs-toggle="modal" data-bs-target="#storyModal"
                ...
                <img src="{{ auth()->user()->profile_picture ? asset('storage/' . auth()->user()->profile_picture) : asset('storage/profiles/defaultuser.svg') }}"
            ...
            @foreach ($stories as $story)
                <div class="story col-3 bg-secondary"
                    ...
                    <a href="{{ route("story.view", $story->id) }}">
                        <img src="{{ $story->getUser->profile_picture ? asset('storage/' . $story->getUser->profile_picture) : asset('storage/profiles/defaultuser.svg') }}"
                            alt="Story 2" style="float:left">
                        <span style="font-weight:bold;color:white">{{ $story->getUser->first_name }}</span>
                    </a>
                </div>
            @endforeach
