                    ...
                    <div class="post-footer">
                        ...
                        <div class="like-container">
                            ...
                            <div class="reactions" id="reaction-box-{{ $post->id }}">
                                <i class="fa-solid fa-thumbs-up like react" data-reaction="like"
                                    data-post-id="{{ $post->id }}" title="Like"></i>
                                <i class="fa-solid fa-heart love react" data-reaction="love"
                                    data-post-id="{{ $post->id }}" title="Love"></i>
                        ...
                        @if ($post->get_reaction_count < 1)
                            <span id="reaction-text">Be the first to Like</span>
                        @endif
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/post" method="post" enctype="multipart/form-data">
                        @csrf
                        <textarea name="caption" placeholder="Say something about your post" style="width: 100%; height: 80px; border:none"></textarea>
